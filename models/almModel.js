...
const qtestSchema = new Schema({
  ...
  label: { type: String, required: true },  // Standardized to match ALM schema

 
});

const ALMdata = mongoose.model("ALM", almSchema);
const Qtest = mongoose.model("Qtest", qtestSchema);

module.exports = { ALMdata, Qtest };  // Correct export format
